...
import com.tribixbite.stoatally.api.routes.server.setDefaultPermissions
import com.tribixbite.stoatally.api.routes.server.setServerPermissions
                        ...
                        try {
                            ...
                            StoatAPI.serverCache[serverId]?.let { s ->
                                ...
                                updatedRoles[roleId] = (updatedRoles[roleId] ?: role)?.copy(
                                    permissions = com.tribixbite.stoatally.core.model.schemas.PermissionDescription(
