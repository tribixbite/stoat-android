...
import com.tribixbite.stoatally.activities.MainActivity
import com.tribixbite.stoatally.api.STOAT_BASE
...
class HandlerService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {
        ...
        serviceScope.launch {
            try {
                // Store the new token
                val kvStorage = com.tribixbite.stoatally.persistence.KVStorage(applicationContext)
