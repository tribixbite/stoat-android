...
sealed class CategorisedChannelList {
    data class Channel(val channel: com.tribixbite.stoatally.core.model.schemas.Channel) :
        CategorisedChannelList()

    data class Category(val category: com.tribixbite.stoatally.core.model.schemas.Category) :
        CategorisedChannelList()
}
